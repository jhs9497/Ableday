...
# def preprocessing_face_cascade_emotion(height):
def preprocessing_face_cascade_emotion():
    # 이미지 경로 조합
    input_file_dir = "/home/ubuntu/S05P21C105/BE/ai-server/classification/data_emotion/inputimage.jpg"
    output_file_dir = "/home/ubuntu/S05P21C105/BE/ai-server/classification/preprocessed_emotion/anger/"
    ...
    for (x,y,w,h) in faces:
        ...
        print(count)
        # 저장한다.
        os.remove(output_file_dir + str(count) + ".jpg")
