...
import com.ssafy.blinddateAuth.common.util.ResponseBodyWriteUtil;
...
public class JwtAuthenticationFilter extends BasicAuthenticationFilter {
	...
	public JwtAuthenticationFilter(AuthenticationManager authenticationManager, UserAuthService userAuthService, UserProfileService userProfileService) {
    ...
    public Authentication getAuthentication(HttpServletRequest request) throws Exception {
        ...
        if (token != null) {
            ...
            if (userId != null) {
                ...
                SsafyUserDetails userDetails = new SsafyUserDetails(userId);
